    ...
    <main className="cacha-page">
      ...
      <section className="dark-section preview" id="receitas">
        ...
        <div className="recipe-grid">
          {["receita-1-600.webp","receita-2-600.webp","receita-3-600.webp","receita-4-600.webp","receita-5-600.webp","receita-6-600.webp","receita-7-600.webp","receita-8-600.webp","receita-9-600.webp","receita-10-600.webp"].map((x,i)=><img key={x} src={IMG+x} alt={"Receita de cachaça "+(i+1)} />)}
        </div>
        <h2>Uma prévia do que você vai receber</h2>
        <div className="recipe-grid preview-grid">
          {["previa-1-600.webp","previa-2-600.webp","previa-3-600.webp","previa-4-600.webp","previa-5-600.webp","previa-6-600.webp","previa-7-600.webp","previa-8-600.webp","previa-9-600.webp","previa-10-600.webp"].map((x,i)=><img key={x} src={IMG+x} alt={"Prévia "+(i+1)} />)}
        </div>
